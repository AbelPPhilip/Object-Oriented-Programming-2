...
public class StudentTests {
	...
	/*
    @Test
	public void FillInTheBlankTest() {
		
		
		ExamQ exam = new ExamQ(1,"Test2",10.0,new String[] {"A","B","C","D"});
		double point = exam.isCorrect(false,new String[] {"A","C"});
		...
		answer.append("\nReport for " + studentName + "\n" + manager.getGradingReport(studentName, 10));
	    System.out.println(manager.getGradingReport(studentName, 10));
    ...
    public void FillInTheBlank() {
		ExamQ exam1 = new ExamQ(1,"Test2",10.0,new String[] {"A","B","C","D"});
	    Exam midterm = new Exam(1,"Midterm");
	    midterm.add(exam1);
	    midterm.add(new ExamQ(2,"Test3",10.0, new String[] {"X","Y","Z"}));
		
		
		Student std = new Student("abel");
		std.answerBlanks(midterm, 1, new String[] {"A","C"});
		std.answerBlanks(midterm, 2, new String [] {"X"});
		System.out.println(std.gradingReport(midterm));
    }*/
